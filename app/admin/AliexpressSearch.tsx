        ...
        <form onSubmit={handleLoad} className="flex gap-2 mb-3">
          <div className="relative flex-1">
            <input
              ...
              className="w-full border border-gray-200 rounded-lg px-3 py-2.5 pr-8 text-sm outline-none focus:border-[#F5A623] transition-colors"
            />
            {urlInput && (
              <button
                type="button"
          ...
          <button
            ...
            className="bg-[#F5A623] text-white text-sm font-bold px-5 py-2.5 rounded-lg hover:bg-[#d8921f] transition-colors disabled:opacity-40 flex-shrink-0"
          >
            {loading ? "로딩 중..." : "불러오기"}
          </button>
        </form>
