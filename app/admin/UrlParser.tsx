...
export default function UrlParser({ onSelect }: Props) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-8">
      ...
      {/* 파싱 결과 */}
      {result && (
        <div className="bg-white border-2 border-[#FF5A00] rounded-xl p-5">
          {/* 헤더: 사이트 + 상품명 + 가격 */}
          <div className="flex items-center gap-2 mb-1">
            <span className="text-[11px] font-bold bg-[#FF5A00] text-white px-2 py-0.5 rounded-full flex-shrink-0">
              {siteLabel}
            </span>
